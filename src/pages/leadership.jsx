        ...
        <div className="container">
          <div className="row space">
            ...
            <div className="col-lg-5">
              <div className="head">
                <p>We successfully cope with tasks of varying complexity, provide long-term guarantees and regularly master new technologies. Our portfolio includes dozens of successfully completed projects of landmarks, roads and industries of various architecture, with high–quality finishes. Making a difference is our vocation!</p>
              </div>
            </div>
          </div>
        </div>
