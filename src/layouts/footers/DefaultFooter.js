...
const DefaultFooter = () => {
        ...
        <div className="container">
            ...
            <div className="footer-first">
                <div className="footer-logo">
                    <Link href="/">
                        <img src={appData.footer.logo.image} alt={appData.footer.logo.alt} style={{height:"100px",width:"150px"}} />
                    </Link>
                </div>
                <div className="contact-info d-flex-all">
                    ...
                    <p>Call us at <span>+91 0000000000</span></p>
                </div>
  ...
  <div className="footer-col">
    ...
    <ul>
      <li>
        <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="79" height="94" viewBox="0 0 79 94">
          <defs>
            <clipPath id="clip-location_B">
              <rect width="79" height="94"/>
            </clipPath>
          </defs>
          <g id="location_B" data-name="location B" clipPath="url(#clip-location_B)">
      ...
      <li>
        <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="102" height="93" viewBox="0 0 102 93">
          <defs>
            <clipPath id="clip-Email_B">
              <rect width="102" height="93"/>
            </clipPath>
          </defs>
          <g id="Email_B" data-name="Email B" clipPath="url(#clip-Email_B)">
        ...
        <p>contact@something.com</p>
            ...
            <div className="col-lg-4 col-md-6 col-sm-12">
                <div className="footer-col">
                    ...
                    <p>Signup here to get the latest news.</p>
